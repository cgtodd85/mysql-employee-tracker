...
const addSome = () => {
  inquirer
    .prompt({
      ...
      choices: ["a new Department", "a new Role", "a new Employee", "EXIT"],
    })
    .then((answer) => {
      switch (answer.action) {
...
const viewSome = () => {
  inquirer
    .prompt({
      ...
      choices: ["Departments", "Roles", "Employees", "Main Menu", "EXIT"],
    })
    .then((answer) => {
      switch (answer.action) {
        case "Departments":
    ...
    .prompt([
      {
        ...
        input: "input",
        message:
          "What is the ID number of the employee who's role you'd like to update?",
      },
      {
        name: "roleUpdate",
        input: "input",
        message:
          "What is the role ID that you'd like to assign to the employee?",
      },
    ])
    .then((answer) => {
